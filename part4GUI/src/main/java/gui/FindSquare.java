...
public class FindSquare
{
		...
		private void confirm()
		{
				try
				{
						...
						CController.numValue1 = CController.figures.get(fig.i).square();
						CController.textValue1 = "Square:";
						CController.markedFigureIndexes = new int[] {fig.i};

						CController.showAlert("Square was found","info",AlertType.INFORMATION);
						log.info("Square was found. Figure:\n"+CController.figures.get(fig.i).toString());
