...
public class RemoveFigure
{
		...
		private void confirm()
		{
				try
				{
						...
						CController.figures.remove(fig.i);

						cbFigures.getItems().remove(fig.i);

						CController.showAlert("Figure was removed","info",AlertType.INFORMATION);
						log.info("Figure was removed. Figure:\n"+CController.figures.get(fig.i).toString());
				}
		...
		private void cancel()
		{
				CController.showAlert("Finished removing figures","info",AlertType.INFORMATION);
